  ...
  useEffect(() => {
    ...
    if (typeof window !== "undefined" && history.isReady) {
      ...
      if (
        ...
        const img =
          process.env.NEXT_PUBLIC_REACT_APP_IMAGES_URL +
          "/" +
          ssrData?.product.images[0].path;
        ssrData?.images.push({
          original:
            process.env.NEXT_PUBLIC_REACT_APP_IMAGES_URL +
            "/" +
          ...
          <>
            {ssrData?.product !== undefined && (
              ...
              >
                <Helmet>
                  <title>
                    {process.env.NEXT_PUBLIC_REACT_APP_TITLE} -{" "}
                    {showValue(ssrData?.product.attributes, "name")}
                  </title>
                  <meta
                    name="description"
                    content={showValue(
                              ...
                              <S.Flex>
                                ...
                                {offerData && offerData.offers[0] && (
                                  <AddCart
                                    ...
                                    loja={
                                      offerData.offers[0].marketplace_seller[0]
                                        .shop_title
                                    }
                                    seller={
                                      offerData.offers[0].marketplace_seller_id
                                    }
                                    valor={
                                      offerData.offers[0].of_to_view
                                        ? offerData.offers[0].promotional_price
